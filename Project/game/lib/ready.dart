...
class _ReadyTimeState extends State<ReadyTime> {
  ...
  void starttimer() {
    cout = Timer.periodic(Duration(seconds: 1), (_) {
      if (time == 5) {
        cancel();
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => PlayPvp(
                  roomid: this.widget.roomid,
                  user1: this.widget.user1,
                  user2: this.widget.user2,
                  index: this.widget.index)),
        );
        final postData = {"ready${this.widget.index}": true};
        FirebaseDatabase.instance
            .ref('room/${this.widget.roomid}')
            .update(postData);
      } else
        setState(() {
          time++;
      ...
      children: [
        ...
        Stack(
          children: [
            ...
            //       decoration: const BoxDecoration(
            //         image: DecorationImage(
            //             image: AssetImage('img/tigerload.gif'),
            //             fit: BoxFit.fill),
            //       ),
            //     ),
            //   ),
