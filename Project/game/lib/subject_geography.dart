...
class Subject_geography extends StatefulWidget {
  const Subject_geography({super.key});

  @override
  State<Subject_geography> createState() => _Subject_geographyState();
}

class _Subject_geographyState extends State<Subject_geography> {
  String id = "";
  String is_logined = "";
  ...
  Future<List<ObjectGeo>> fetchgeography() async {
    var records =
        await FirebaseFirestore.instance.collection('objectgeography').get();
  ...
  Widget build(BuildContext context) {
    Widget builduser(ObjectGeo user) {
      if (user.id == id) {
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    Querrries(object: "Địa Lý", level: 1)),
                          );
                        },
                        child: Stack(
                          children: [
                        ...
                        onTap: () {
                          if (user.level2) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Địa Lý", level: 2)),
                            );
                          }
                        },
                        child: Stack(
                        ...
                        onTap: () {
                          if (user.level3) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Địa Lý", level: 3)),
                            );
                          }
                        },
                        child: Stack(
                        ...
                        onTap: () {
                          if (user.level4) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Địa Lý", level: 4)),
                            );
                          }
                        },
                        child: Stack(
    ...
    return Scaffold(
      body: Container(
          ...
          child: FutureBuilder<List<ObjectGeo>>(
            future: fetchgeography(),
