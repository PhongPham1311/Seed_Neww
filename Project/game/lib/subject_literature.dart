...
class Subject_literature extends StatefulWidget {
  const Subject_literature({super.key});

  @override
  State<Subject_literature> createState() => _Subject_literatureState();
}

class _Subject_literatureState extends State<Subject_literature> {
  String id = "";
  String is_logined = "";
  ...
  Future<List<Objectliteratures>> fetchliterature() async {
    var records =
        await FirebaseFirestore.instance.collection('objectliterature').get();
    final _list = records.docs
        .map((e) => Objectliteratures(
            id: e["id"],
            level1: e["level1"],
            score1: e["score1"],
            level2: e["level2"],
  ...
  Widget build(BuildContext context) {
    Widget builduser(Objectliteratures user) {
      if (user.id == id) {
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    Querrries(object: "Văn Học", level: 1)),
                          );
                        },
                        child: Stack(
                          children: [
                        ...
                        onTap: () {
                          if (user.level2) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Văn Học", level: 2)),
                            );
                          }
                        },
                        child: Stack(
                        ...
                        onTap: () {
                          if (user.level3) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Văn Học", level: 3)),
                            );
                          }
                        },
                        child: Stack(
                        ...
                        onTap: () {
                          if (user.level4) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Văn Học", level: 4)),
                            );
                          }
                        },
                        child: Stack(
    ...
    return Scaffold(
      body: Container(
          ...
          child: FutureBuilder<List<Objectliteratures>>(
            future: fetchliterature(),
