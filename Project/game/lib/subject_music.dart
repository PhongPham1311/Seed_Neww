...
class Subject_Mucsic extends StatefulWidget {
  const Subject_Mucsic({super.key});

  @override
  State<Subject_Mucsic> createState() => _Subject_MucsicState();
}

class _Subject_MucsicState extends State<Subject_Mucsic> {
  String id = "";
  String is_logined = "";
  ...
  Future<List<ObjectMucsic>> fetchmucsic() async {
    var records =
        await FirebaseFirestore.instance.collection('objectmucsic').get();
  ...
  Widget build(BuildContext context) {
    Widget builduser(ObjectMucsic user) {
      if (user.id == id) {
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    Querrries(object: "Âm Nhạc", level: 1)),
                          );
                        },
                        child: Stack(
                          children: [
                        ...
                        onTap: () {
                          if (user.level2) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Âm Nhạc", level: 2)),
                            );
                          }
                        },
                        child: Stack(
                        ...
                        onTap: () {
                          if (user.level3) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Âm Nhạc", level: 3)),
                            );
                          }
                        },
                        child: Stack(
                        ...
                        onTap: () {
                          if (user.level4) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Âm Nhạc", level: 4)),
                            );
                          }
                        },
                        child: Stack(
    ...
    return Scaffold(
      body: Container(
          ...
          child: FutureBuilder<List<ObjectMucsic>>(
            future: fetchmucsic(),
