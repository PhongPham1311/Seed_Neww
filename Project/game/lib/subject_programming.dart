...
class Subject_Programing extends StatefulWidget {
  const Subject_Programing({super.key});

  @override
  State<Subject_Programing> createState() => _Subject_ProgramingState();
}

class _Subject_ProgramingState extends State<Subject_Programing> {
  String id = "";
  String is_logined = "";
  ...
  Future<List<ObjectProgram>> fetchprograming() async {
    var records =
        await FirebaseFirestore.instance.collection('objectprograming').get();
  ...
  Widget build(BuildContext context) {
    Widget builduser(ObjectProgram user) {
      if (user.id == id) {
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    Querrries(object: "Lập Trình", level: 1)),
                          );
                        },
                        child: Stack(
                          children: [
                        ...
                        onTap: () {
                          if (user.level2) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Lập Trình", level: 2)),
                            );
                          }
                        },
                        child: Stack(
                        ...
                        onTap: () {
                          if (user.level3) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Lập Trình", level: 3)),
                            );
                          }
                        },
                        child: Stack(
                        ...
                        onTap: () {
                          if (user.level4) {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Querrries(object: "Lập Trình", level: 4)),
                            );
                          }
                        },
                        child: Stack(
    ...
    return Scaffold(
      body: Container(
          ...
          child: FutureBuilder<List<ObjectProgram>>(
            future: fetchprograming(),
